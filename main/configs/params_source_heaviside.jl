...
const y_l = -5.0
const y_r = 5.0
const mx = 1200                     # grid points in x
const my = 600                     # grid points in y
...
const DESC_STRING = "M-S=$(M_ORDER)-$(S_ORDER)_mu$(μ_tag)_t0_$(replace(string(T0), "." => "_"))_SIGMA_$(replace(string(SIGMA), "." => "_"))_SCHEMA_$(SCHEMA)_$(PERIODIC ? "periodic" : "non_periodic")_IC_$(INITIAL_CONDITION)_order_$(SBP_ORDER)_mxmy_$(mx)x$(my)"
