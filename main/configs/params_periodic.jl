...
const PERIODIC = true          # periodicity toggle
const SCHEMA = :upwind            # :narrow, :wide, :mixed, :upwind, :mixed_upwind_μ, :mixed_upwind_λ and :staggered
...
const y_l = -1.0
const y_r = 1.0
const mx = 50                     # grid points in x
const my = 50                     # grid points in y
