function [parameters, trueParameters] = rsFriction2DFractalFaultInversion(opts)
    default_arg('opts',struct);
    default_field(opts,'m',251);
    default_field(opts,'m_p',26);
    default_field(opts,'k',0.003);
   ...
   %% Initial conditions
    ...
    if opts.doFilter
        ...
        filterOpts.order = 6;
        filterOpts.zero_delay = false;
        filterOpts.filterResidual = true;
    else 
        filterOpts = [];
    end
