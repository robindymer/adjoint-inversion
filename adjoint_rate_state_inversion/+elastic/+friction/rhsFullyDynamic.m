function U_t = rhsFullyDynamic(t, U, ops, friction, preStress, mms)
	...
	u_t = v;
	if ~isempty(ops.mex)
		v_t = ops.D*u + elastic.mex.elasticOperatorMultiblock(u, ops.mex.g, ops.mex.RHOJi, ops.mex.PHI, ops.mex.ops);
	else
		v_t = ops.D*u;
	end
