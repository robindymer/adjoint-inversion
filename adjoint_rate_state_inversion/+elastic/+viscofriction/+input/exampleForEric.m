function [domain, friction, preStress, material, mms, flowLaw, plotting, tectonic, timeStepper, output] = exampleForEric()
	...
	friction.L = 8*0.008;			% Critical slip distance (used in reg. friction coeff)

	% Set state variable to steady-state
	Vp = 1e-9;
	% friction.psi0 = friction.L/Vp;
