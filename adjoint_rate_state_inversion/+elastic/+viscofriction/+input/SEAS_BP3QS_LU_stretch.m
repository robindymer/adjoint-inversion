function [domain, friction, preStress, material, mms, flowLaw, plotting, tectonic, timeStepper, output] = SEAS_BP3QS_LU_stretch(outputDir, MODE, dipAngle, faultMotion)
	...
	stretchingDistX = 10*Lx;
	stretchingDistY = 10*Ly;
	stretchingRatio = 20;

	def = domains.DippingFault(dipAngle, Wf, Lx, Ly, stretchingDistX, stretchingDistY, stretchingRatio, stretchingRatio);
