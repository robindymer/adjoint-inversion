...
void D2x_6th(double *u_x, double *v_x, double *u, double *v, double *b, double dx, int Nx, int Ny)
{
                  ...
                  int nrhs, const mxArray *prhs[])
{
    ...
    int numThreads = (int) mxGetScalar(prhs[7]);
    ...
    if (order == 2){
        ...
        D2x_6th(out1, out2, u, v, b, dx, Nx, Ny);
    }
}