classdef SupergridLayerW < multiblock.DefCurvilinear
    properties
        p
        m
        ratio
    ...
    methods
        % curves: cell array of tangential curves for each block
        function obj = SupergridLayerW(p, h0, m, ratio, curves)
            default_arg('m',51);
            ...
            boundaryGroups.W = multiblock.BoundaryGroup(farfieldBG);
