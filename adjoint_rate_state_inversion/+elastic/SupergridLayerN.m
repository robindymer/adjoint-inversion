classdef SupergridLayerN < multiblock.DefCurvilinear
    properties
        p
        m
        ratio
    ...
    methods
        function obj = SupergridLayerN(p, h0, m, ratio, curves)
            default_arg('m',51);
            ...
            boundaryGroups.N = multiblock.BoundaryGroup(farfieldBG);
