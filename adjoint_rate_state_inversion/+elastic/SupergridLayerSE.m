classdef SupergridLayerSE < multiblock.DefCurvilinear
    properties
        p
        m
        ratio
    ...
    methods
        function obj = SupergridLayerSE(p, h0x, h0y, m, ratio)
            default_arg('m',51);
            ...
            boundaryGroups.farfield = multiblock.BoundaryGroup({{1,'e'}, {1,'s'}});
