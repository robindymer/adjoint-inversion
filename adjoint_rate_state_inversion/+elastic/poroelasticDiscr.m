classdef poroelasticDiscr < noname.Discretization
    properties
        name         = 'poroelastic 2D'
    ...
    methods
        ...
        function obj = poroelasticDiscr(m, order, xlim, ylim, coeff_fun, F, boundary_data, opSet, BCstrength)
            ...
            Hi = diffOpElastic.Hi;
            H_gamma = diffOpElastic.H_boundary{2};
