classdef SupergridLayerNW < multiblock.DefCurvilinear
    properties
        p
        m
        ratio
    ...
    methods
        function obj = SupergridLayerNW(p, h0x, h0y, m, ratio)
            default_arg('m',51);
            ...
            boundaryGroups.farfield = multiblock.BoundaryGroup({{1,'w'}, {1,'n'}});
